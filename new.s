...
Main..new:              ## constructor for Main
			...
			movq %rax, %r12
                        ...
                        popq %rbp
                        movq %r13, 40(%r12)
                        ## self[6] holds field b (B)
                        movq $0, %r13
                        movq %r13, 48(%r12)
                        ## self[7] holds field c (B)
                        movq $0, %r13
                        movq %r13, 56(%r12)
                        ## self[3] x initializer <- new Int
                        ## new Int
                        pushq %rbp
                        pushq %r12
                        movq $Int..new, %r14
                        ...
                        popq %rbp
                        movq %r13, 32(%r12)
                        ## self[5] s initializer <- new String
                        ## new String
                        pushq %rbp
                        pushq %r12
                        movq $String..new, %r14
